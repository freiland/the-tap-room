    ...
    <div className={classes.root}>
      <AppBar position="static">
        <Toolbar className={classes.toolbar}>
          ...
          >
            Cart
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-minecart" viewBox="0 0 16 16" marginRight='10'>
          ...
          <Typography className={classes.title} variant="h5" noWrap>
            The Tap Room <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cloud-haze" viewBox="0 0 16 16">
